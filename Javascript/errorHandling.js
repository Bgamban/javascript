// Menampilkan Reject karena sebelumnya hanya Resolvenya saja
...
function getMovies(keyword) {
  return fetch("postman + keyword")
    .then((response) => response.json())
    .then((response) => response.Search);
}
// Event Binding adalah memberi event ke elemen yang belum ada lalu ketika ada eventnya dapat berjalan
